...
public:
    ...
    string getisHLTInstruction()const;
    int getOption()const;
    void setRegisters(int value, int index);
    void setPC(int value);
    void setHLTIndex(int index);
    void setisHLTInstruction(string _instruction);
    void setOption(int theOption);
    void print() const;
    void print(int ignore)const;
    bool halted() const;
...
private:
    ...
    string isHLTInstruction;

    //jumps to target line of the program if the value of register is zero or smaller.
    void JPNInstruction(string instruction, Memory& memoryObj);
    //if there is any error instruction exits program 
    //Do JMP reg,lineAdress operation
    void JumpInstructionWithTwoOperand(string instruction, Memory& memoryObj);
    //if there is any error instruction exits program 
    //Do JMP  lineAdress
    void JumpInstructionWithOneOperand(string instruction, Memory& memoryObj);
    //if there is any error instruction exits program 
